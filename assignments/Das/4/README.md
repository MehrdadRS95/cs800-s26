...
[Open PDF](latex_files/CS_800__A4_Das.pdf)

🧾 **Main LaTeX File**  
[main.tex](latex_files/main.tex)
...
│
├── A4_papers/
│   └── (Five research papers used for the literature review)
│
├── latex_files/
│   ├── main.tex
│   ├── litreview.bib
...
| File | Description |
|-----|-------------|
| `latex_files/CS_800__A4_Das.pdf` | Final compiled PDF of the literature review |
| `latex_files/main.tex` | Main LaTeX source file containing the Introduction, Summaries, and Synthesis sections |
| `latex_files/litreview.bib` | BibTeX bibliography file containing references |
...
- vulnerabilities in secure code generation  
- backdoor attacks in natural language processing models  
- guardrail frameworks for improving LLM agent safety  

These works collectively examine both **attack mechanisms and defensive strategies** aimed at improving the reliability and security of modern LLM-based systems.

---

# Papers Included

1. **Xiang, Z. et al. (2025)**  
   *GuardAgent: Safeguard LLM Agents via Knowledge-Enabled Reasoning*

2. **Thomas, R. K. et al. (2025)**  
   *Hidden No More: Attacking and Defending Private Third-Party LLM Inference*

3. **Tessa, M. et al. (2026)**  
   *How Secure is Secure Code Generation? Adversarial Prompts Put LLM Defenses to the Test*

4. **Cheng, P. et al. (2025)**  
   *Backdoor Attacks and Countermeasures in Natural Language Processing Models*

5. **Asl, J. R. et al. (2025)**  
