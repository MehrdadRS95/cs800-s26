...
Across these studies, a clear progression emerges in honeynet research, moving from foundational frameworks to adaptive, hybrid, and domain-specific architectures \cite{mokube2007honeypots}. Early work provides essential classifications and operational guidance for honeypots, establishing a baseline for understanding their deployment, benefits, and limitations. Subsequent studies build on this foundation by introducing hybrid designs \cite{minjiao2022dynamic} that combine virtual and physical devices, improving realism and engagement with attackers \cite{javadpour2024survey}.
